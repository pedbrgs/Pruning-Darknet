# Developed by Ultralytics (https://github.com/ultralytics/yolov3)
...
def model_info(model, verbose=False):
    ...
    print('Model Summary: %d layers, %d parameters, %d gradients%s' % (len(list(model.parameters())), n_p, n_g, fs))
